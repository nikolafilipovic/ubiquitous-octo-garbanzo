                ...
                <div class="container"> 
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-link">
                            <a href="/search-homes/"><h1>Search homes for sale</h1><i class="fas fa-arrow-right"></i></a>
                            <p>Homes updated every 2 minutes. See every home on the market.</p>      
                            <div class="separator"></div>                      
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-link">
                            <a href="/search-homes/"><h1>Search foreclosures</h1><i class="fas fa-arrow-right"></i></a>
                            <p>Make offers with just a click. Get new property and price change alerts.</p>      
                            <div class="separator"></div>                      
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-link">
                            <a href="/find-my-local-pro/"><h1>Talk to a local pro</h1><i class="fas fa-arrow-right"></i></a>
