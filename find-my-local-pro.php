...
<div class="fmlp-body">
  <div class="fmlp-floating-block">
    ...
    <div class="one-row">
      ...
      <p>Each Offer Company Agent is a local expert. Our agents use local knowledge and proprietary data to negotiate the best deal for you.</p>
    </div>

    <div class="one-row">
      <h2>We have your back</h2>
      <p>Each Offer Company Agents are customer advocates. We're accountable for helping our clients buy and sell the right home, at the right price.</p>
    </div>
  </div>
